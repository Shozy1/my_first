...
# Extract the latest exchange rate depreciation (for the most recent period)
latest_depreciation = data['EXR_Depreciation'].iloc[-1]

# Use st.metric with the latest depreciation value
st.metric(label="Change in Exchange Rate", value=1587.39, delta=f"{latest_depreciation:.2f}%", delta_color="normal")
